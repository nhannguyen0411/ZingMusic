const strangeVideo = [
  ...
  {
    id: 5,
    song: "Những bài hát hoa ngữ kinh điển",
    singer: [
      { id: 21, singer: "Lil Zpoet" },
      { id: 22, singer: "Đức Anh" },
    ],
  ...
  {
    id: 7,
    song: "Chỉ có thể là Wanbi Tuấn anh",
    singer: [
      { id: 21, singer: "Lil Zpoet" },
      { id: 22, singer: "Đức Anh" },
    ],
