const albumHot = [
  {
    ...
    song: "Từ Em Mà Ra",
    singer: [
      { id: 21, singer: "Lil Zpoet" },
      { id: 22, singer: "Đức Anh" },
    ],
    image:
  ...
  {
    id: 3,
    song: "Yêu em thật đấy",
    singer: [{ id: 25, singer: "Đinh tùng huy" }],
    image:
  ...
  {
    id: 4,
    song: "Cho em yêu anh hon",
    singer: [
      { id: 26, singer: "Thu thủy" },
      { id: 27, singer: "Kin nguyễn" },
    ],
    image:
  ...
  {
    id: 6,
    song: "Chẳng biết nói gì hôm nay",
    singer: [
      { id: 29, singer: "Phạm Việt thắng" },
      { id: 30, singer: "Masew" },
    ],
    image:
  ...
  {
    id: 7,
    song: "Em hạnh phúc không",
    singer: [{ id: 31, singer: "khánh đơn" }],
    image:
  ...
  {
    id: 8,
    song: "Sợ người ta cướp mất em",
    singer: [{ id: 32, singer: "Vũ Duy Khánh" }],
    image:
  ...
  {
    id: 9,
    song: "Duyên tình vợ chồng",
    singer: [{ id: 33, singer: "Vy Oanh" }],
    image:
  ...
  },
  {
    id: 10,
    song: "Anh sợ yêu",
    singer: [{ id: 34, singer: "Anh Quân Idol" }],
    image:
  ...
  {
    id: 11,
    song: "Càng đẹp càng độc",
    singer: [{ id: 35, singer: "Quyn Si" }],
    image:
